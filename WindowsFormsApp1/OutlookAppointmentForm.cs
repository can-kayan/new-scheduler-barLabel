...
namespace WindowsFormsApp1
{
    ...
    public partial class OutlookAppointmentForm : DevExpress.XtraBars.Ribbon.RibbonForm, IDXManagerPopupMenu
    {
        ...
        Form1 f1;
        public OutlookAppointmentForm(Form1 frm1)
        {
            InitializeComponent();
            f1 = frm1;
        }
        public OutlookAppointmentForm(DevExpress.XtraScheduler.SchedulerControl control, Appointment apt, Form1 frm1)
            : this(control, apt, false,frm1)
        {
            f1 = frm1;
        }
        public OutlookAppointmentForm(DevExpress.XtraScheduler.SchedulerControl control, Appointment apt, bool openRecurrenceForm, Form1 frm1)
        {
